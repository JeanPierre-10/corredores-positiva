...
{
    public class ReglasMensualReq : AbstractValidator<ProduccionRequest>
    {
        public ReglasMensualReq()
        {
            ...
            RuleFor(x => x.FinConsulta)
                 .NotNull()
                 .WithMessage("Fecha de fin de consulta no debe ser null")
                 .NotEmpty()
                 .WithMessage("Fecha de fin de consulta no debe estar en blanco")
                 .Must(validarFormato).WithMessage("Fecha de fin de consulta debe tener formato yyyy-MM-dd");
        }
